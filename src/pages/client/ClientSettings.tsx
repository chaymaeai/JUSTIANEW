...
type SectionId = "securite" | "notifications" | "confidentialite";
...
const [userData, setUserData] = useState<Record<string, unknown> | null>(null);
  ...
  notif_email_demande: notif.emailReponse,   
  ...
  // Ajoute après handleDeleteAccount
        ...
        {section === "notifications" && (
          <div className="space-y-4">
            ...
            <div className="rounded-xl border border-slate-200 bg-white dark:border-slate-800 dark:bg-slate-900 p-6">
              ...
              <div className="space-y-2">
                {[
                  { key: "emailReponse", label: "Nouvelle réponse à ma demande", desc: "Reçu dès qu'un expert répond" },
          ...
          <div className="space-y-4">
            ...
            <div className="rounded-xl border border-red-200 bg-red-50 dark:border-red-900 dark:bg-red-950/20 p-6">
              ...
              <p className="text-sm text-red-600 dark:text-red-300 mb-4">
                La suppression de votre compte est définitive. Toutes vos données, demandes, documents et factures seront effacés sans possibilité de récupération.
              </p>
              <Button
    ...
    <div className="w-full max-w-md rounded-xl border border-slate-200 bg-white dark:border-slate-800 dark:bg-slate-900 p-6 shadow-xl">
      ...
      <div className="space-y-2">
        {[
          ...
          { label: "Membre depuis", value: userData.created_at
